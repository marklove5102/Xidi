...
set files_release_build_Win32=Xidi.32.dll Xidi.HookModule.32.dll
set files_release_build_x64=Xidi.64.dll Xidi.HookModule.64.dll

set files_sdk_include=Include\Xidi\*.h
